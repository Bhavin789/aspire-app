...
export const HomeSvg = ({ isSelected }: { isSelected?: boolean }) => {
    return (
        <svg
        ...
        >
            ...
            <g transform="translate(-2 4)">
                ...
                <g transform="translate(2 -4)">
                    <path
                        fill={isSelected ? colorTokens.light.brand : "white"}
...
export const CardSvg = ({ isSelected }: { isSelected?: boolean }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
            ...
            <g transform="translate(-2.5 4)">
                ...
                <g transform="translate(2.5 -91.333)">
                    <g transform="translate(0 98.333)">
                        <path
                            fill={
                                isSelected ? colorTokens.light.brand : "white"
                            }
...
export const SettingsSvg = ({ isSelected }: { isSelected?: boolean }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="20.023"
...
export const PaymentsSvg = ({ isSelected }: { isSelected?: boolean }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
...
export const CreditSvg = ({ isSelected }: { isSelected?: boolean }) => {
    return (
        <svg
            xmlns="http://www.w3.org/2000/svg"
            width="24"
